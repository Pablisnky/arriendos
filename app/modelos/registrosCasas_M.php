<?php
    class registrosCasas_M{
        ...
        public function consultarCasas($Precio, $TipoInmueble, $Negociacion){
            //Se consulta las habitaciones disponibles
            $this->db->Consulta("SELECT * FROM inmueble WHERE tipo_negociacion = '$Negociacion' AND tipo_inmueble= '$TipoInmueble' AND precio <= $Precio AND pago != 2");
